...
import { Quat, Vec3, Mat3, Euler } from "./types";
...
export const rotationTo = (function () {
	...
	return function (out: Quat, a: Vec3, b: Vec3): Quat {
...
export const sqlerp = (function () {
	...
	return function (out: Quat, a: Quat, b: Quat, c: Quat, d: Quat, t: number): Quat {
		slerp(temp1, a, d, t);
		slerp(temp2, b, c, t);
...
export const setAxes = (function () {
	...
	return function (out: Quat, view: Vec3, right: Vec3, up: Vec3): Quat {
		matr[0] = right[0];
		matr[3] = right[1];
		matr[6] = right[2];
